...
<body class="semi-light">
  ...
  <div class="footer-compensate">
    ...
    <div class="container">
      <div class="">
        <p class="question-expand cola-title shade">Click Here To Display The Content</p>
        <p class="question-content cola-text">This is the content, but now is... Well, visible!"</p>
      </div>
